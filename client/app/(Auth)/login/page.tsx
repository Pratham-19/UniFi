    ...
    <>
      ...
      <main className="w-screen h-[90vh] bg-[#F1F1F1] grid md:grid-cols-2 grid-flow-row">
        <div className="md:w-[600px] w-[510px] py-4 flex flex-col justify-center items-center gap-4 px-[64px] place-self-center">
          ...
          <button className="w-[100%] hover:shadow-[0px_6px_0px_0px_#091D31] h-fit rounded-[8px] px-8 py-3 flex gap-4 justify-center border-[1px] border-solid border-[#091D31] hover:scale-x-95 transition-transform duration-300">
            <Image
              src={'/google.svg'}
              alt="google"
              height={40}
