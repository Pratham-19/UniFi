...
contract Utils {
    ...
    mapping(uint256 chainId => uint64 toolIndex) public chainIdToToolIndex;
    ...
    function getToolIndex(uint256 chainId) public view returns (uint64) {
     ...
     */
    function setToolIndex(uint256 chainId, uint64 index) public {
